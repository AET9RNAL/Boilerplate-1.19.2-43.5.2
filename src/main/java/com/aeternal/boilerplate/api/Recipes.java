package com.aeternal.boilerplate.api;

import com.aeternal.boilerplate.recipe.CraftingManager;
import com.aeternal.boilerplate.recipe.IInputHandler;
import com.aeternal.boilerplate.recipe.InputHandler;
...
public class Recipes {
    ...
    public static String registerRecipe(Recipe<?> Recipe) {
        String id = "boilerplate:" + "boilerplate_" + recipeID++;
