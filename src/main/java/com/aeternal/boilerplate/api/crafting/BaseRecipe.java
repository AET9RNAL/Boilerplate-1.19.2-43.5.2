package com.aeternal.boilerplate.api.crafting;
...
import com.aeternal.boilerplate.recipe.InputItemStack;
import com.aeternal.boilerplate.recipe.InputOreDict;
...
public class BaseRecipe extends ShapedRecipe {
    ...
    public BaseRecipe(ItemStack output, RecipeGrid recipeGrid, List<PartRecipe> partRecipe) {
        this(ResourceLocation.tryParse("minecraft:minecraft"), "", output, recipeGrid, partRecipe);
